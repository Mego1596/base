...
public class InsertarTabla1 extends AppCompatActivity implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    public void cargarWebServiceLocal(View v){
        if(codigoMateria.getText().toString().isEmpty() || nombreMateria.getText().toString().isEmpty() || unidadesValorativas.getText().toString().isEmpty()){
            ...
            String url ="http://192.168.1.113/ws_insertar_materia.php?codmateria="+ codigoMateria.getText().toString()+
    ...
    public void cargarWebServiceExterno(View v){
        if(codigoMateria.getText().toString().isEmpty() || nombreMateria.getText().toString().isEmpty() || unidadesValorativas.getText().toString().isEmpty()){
            ...
            String url ="https://go14002.000webhostapp.com//ws_insertar_materia.php?codmateria="+ codigoMateria.getText().toString()+
                    "&nommateria="+nombreMateria.getText().toString()+
                    "&unidadesval="+unidadesValorativas.getText().toString();
            url=url.replace(" ","%20");
